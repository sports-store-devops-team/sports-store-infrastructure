...
AWS_ACCOUNT='796231892654'
AWS_ARN='arn:aws:iam::796231892654:user/Niv-Bar'
...
jq() {
  local expression="${*: -1}"
  case "$expression" in
    '.expected_account_id | select(type == "string" and length > 0)') printf '796231892654\n' ;;
    '.aws_region | select(type == "string" and length > 0)') printf 'eu-central-1\n' ;;
    '.deployment_principal_arn | select(type == "string" and length > 0)') printf 'arn:aws:iam::796231892654:user/Niv-Bar\n' ;;
...
assert_identity_accepted '796231892654' 'arn:aws:iam::796231892654:user/Niv-Bar' 'expected IAM user'
assert_identity_accepted '796231892654' 'arn:aws-us-gov:iam::796231892654:role/team/DeploymentRole' 'expected IAM role'
assert_identity_accepted '796231892654' 'arn:aws-cn:sts::796231892654:assumed-role/DeploymentRole/github-actions' 'expected assumed role'
...
assert_identity_rejected '796231892654' 'arn:aws:iam::796231892654:root' 'root identity'
assert_identity_rejected '796231892654' 'arn:aws:sts::796231892654:federated-user/example' 'federated user'
assert_identity_rejected '796231892654' 'arn:aws:iam::796231892654:role/' 'malformed ARN'
...
EXPECTED_AWS_ACCOUNT_ID='796231892654'
...
terraform() {
  case "$TERRAFORM_MODE:$*" in
    ...
    'correct:'*' output -raw expected_aws_account_id') printf '796231892654\n' ;;
