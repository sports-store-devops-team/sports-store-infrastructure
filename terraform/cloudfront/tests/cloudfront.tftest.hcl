...
run "enabled_with_a_valid_alb_origin" {
  ...
  variables {
    ...
    static_site_bucket_name                 = "sports-store-static-796231892654-eu-central-1"
    static_site_bucket_arn                  = "arn:aws:s3:::sports-store-static-796231892654-eu-central-1"
    static_site_bucket_regional_domain_name = "sports-store-static-796231892654-eu-central-1.s3.eu-central-1.amazonaws.com"
  }
